  ...
  return (
    <div className="fixed bottom-4 left-4 z-50 flex flex-col gap-3">
      ...
      <button
        ...
        className="rounded-full border border-slate-200 bg-white p-2 text-slate-700 shadow-lg transition hover:bg-purple-200 dark:border-slate-700 dark:bg-slate-900 dark:hover:bg-purple-800 dark:text-slate-100"
        aria-pressed={isDyslexia}
        title={isDyslexia ? "Desactivar modo dislexia" : "Activar modo dislexia"}
      >
        <svg 
          className={isDyslexia ? "h-6 w-6 text-purple-600 dark:text-purple-400" : "h-6 w-6 text-slate-700 dark:text-slate-300"} 
          fill="currentColor" 
      ...
      <button
        onClick={toggle}
        className="rounded-full border border-slate-200 bg-white p-2 text-slate-700 shadow-lg transition hover:bg-sky-400 dark:border-slate-700 dark:bg-slate-900 dark:hover:bg-sky-900 dark:text-slate-100"
        aria-pressed={isDark}
        title="Cambiar tema"
      >
        {isDark ? (
          <svg className="h-6 w-6 text-amber-100" viewBox="-1 -1 26 26" fill="currentColor">
          ...
          <svg className="h-6 w-6 text-yellow-400" viewBox="2 3 27 27" fill="currentColor">
